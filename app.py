...
def Installing_the_Cpp_compiler_and_CodeBlocks_IDE():
    return render_template("C++/installing-compiler-and-codeblocks-ide.html", curLink = TOPIC_DICT["C++"][0][1], curTitle=TOPIC_DICT["C++"][0][0],  nextLink = TOPIC_DICT["C++"][1][1], nextTitle = TOPIC_DICT["C++"][1][0], curTopic = "C++", title = TOPIC_DICT["C++"][0][0], TOPIC_DICT = TOPIC_DICT, TUTORIAL_CAT = TUTORIAL_CAT)
...
def Creating_a_Hello_World_program_in_Cpp():
    return render_template("C++/hello-world.html", curLink = TOPIC_DICT["C++"][1][1], curTitle=TOPIC_DICT["C++"][1][0], curTopic = "C++", title = TOPIC_DICT["C++"][1][0], TOPIC_DICT = TOPIC_DICT, TUTORIAL_CAT = TUTORIAL_CAT, nextTitle= "None")
...
def Getting_user_input_and_variables():
    return render_template("C++/user-input-and-variables.html", curLink = TOPIC_DICT["C++"][2][1], curTitle=TOPIC_DICT["C++"][2][0], curTopic = "C++", title = TOPIC_DICT["C++"][2][0], TOPIC_DICT = TOPIC_DICT, TUTORIAL_CAT = TUTORIAL_CAT, nextTitle= "None")
...
def Data_Types():
    return render_template("C++/data-types.html", curLink = TOPIC_DICT["C++"][3][1], curTitle=TOPIC_DICT["C++"][3][0], curTopic = "C++", title = TOPIC_DICT["C++"][3][0], TOPIC_DICT = TOPIC_DICT, TUTORIAL_CAT = TUTORIAL_CAT, nextTitle= "None")
