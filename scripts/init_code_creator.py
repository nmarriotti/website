...
def CURRENTTITLE():
    return render_template("tutorials/CURRENTTOPICLOW/CURRENTHTML", curLink = TOPIC_DICT["CURRENTTOPIC"][CURRENTINDEX][1], curTitle=TOPIC_DICT["CURRENTTOPIC"][CURRENTINDEX][0], title=TOPIC_DICT["CURRENTTOPIC"][CURRENTINDEX][0], curTopic="CURRENTTOPIC",  nextLink = TOPIC_DICT["CURRENTTOPIC"][NEXTINDEX][1], nextTitle = TOPIC_DICT["CURRENTTOPIC"][NEXTINDEX][0], TOPIC_DICT = TOPIC_DICT)
