...
def CURRENTTITLE():
    return render_template("CURRENTTOPIC/CURRENTHTML", curLink = BLOG_TOPIC_DICT["CURRENTTOPIC"][CURRENTINDEX][1], curTitle=BLOG_TOPIC_DICT["CURRENTTOPIC"][CURRENTINDEX][0], curTopic = "CURRENTTOPIC", title = BLOG_TOPIC_DICT["CURRENTTOPIC"][CURRENTINDEX][0], BLOG_TOPIC_DICT = BLOG_TOPIC_DICT, TUTORIAL_CAT = TUTORIAL_CAT, nextTitle= "None")
